  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl w-full text-center relative z-10">
        {/* Greeting */}
        <p className="text-accent text-lg md:text-xl font-medium mb-4 tracking-wide">
          {t.hero.greeting}
        </p>
        ...
        <p 
          ref={subtitleRef}
          className="text-xl md:text-2xl text-text-secondary mb-4 tracking-wide font-medium"
        >
          {t.hero.role}
        </p>
        ...
        <p className="text-base md:text-lg text-text-secondary/80 mb-12 max-w-3xl mx-auto leading-relaxed">
          {t.hero.description}
        </p>
        ...
        <div ref={buttonsRef} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            ...
            className="group px-10 py-4 bg-accent text-white rounded-lg hover:bg-accent/90 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-accent/30 w-full sm:w-auto font-semibold text-lg relative overflow-hidden inline-flex items-center justify-center"
          >
          ...
          <button
            ...
            className="px-10 py-4 bg-dark-secondary/80 backdrop-blur-sm text-text-primary border-2 border-dark-tertiary rounded-lg hover:border-accent transition-all duration-300 hover:scale-105 w-full sm:w-auto font-semibold text-lg"
          >
            {t.hero.viewProjects}
          </button>
        </div>
